...
def LOSS(x):
    ...
    LEAK = I_rHSS*W_HSS*0.8 + I_rHSS1V8*W_HSS1V8*1.8 + I_rLSS*W_LSS*VIN
    DYN = (Q_HSS*W_HSS*0.95 + Q_HSS1V8*W_HSS1V8*0.05 + Q_LSS*W_LSS)*(1.8)*f_sw + (C_L*f_sw/2)*0.8**2 + (Q_D_0V8_nmos*(W_LSS+W_HSS)+Q_D_0V8_pmos*W_HSS1V8)*f_sw*0.8*0.95/2 + (Q_D_1V8_nmos*(W_LSS+W_HSS)+Q_D_1V8_pmos*W_HSS1V8)*f_sw*1.8*0.05/2
