...
C {devices/lab_pin.sym} 160 30 2 0 {name=p18 sig_type=std_logic lab=OSC}
C {devices/lab_pin.sym} 350 -110 2 1 {name=p19 sig_type=std_logic lab=OSC}
C {devices/lab_pin.sym} 160 10 2 0 {name=p20 sig_type=std_logic lab=EN_START}
...
C {devices/capa.sym} 220 -110 0 0 {name=C2
m=1
value=10n
footprint=1206
device="ceramic capacitor"}
C {devices/lab_pin.sym} 220 -80 2 1 {name=p26 sig_type=std_logic lab=VSS}
C {devices/lab_pin.sym} -140 -30 0 0 {name=p10 sig_type=std_logic lab=VOUT_1V8}
C {devices/lab_pin.sym} 160 -10 0 1 {name=p13 sig_type=std_logic lab=VOUT_1V8}
