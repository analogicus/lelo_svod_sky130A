...
C {devices/lab_pin.sym} -730 -100 0 0 {name=p15 sig_type=std_logic lab=VSS}
C {devices/lab_pin.sym} -730 -140 0 0 {name=p16 sig_type=std_logic lab=VDD_0V8}
C {devices/lab_pin.sym} -430 -120 0 1 {name=p17 sig_type=std_logic lab=IBP_3n}
C {devices/ipin.sym} -560 -350 0 0 {name=p1 lab=VDD_0V8}
C {devices/lab_pin.sym} -430 -140 0 1 {name=p20 sig_type=std_logic lab=OSC}
...
device=resistor
m=1}
C {LELO_SVOD_SKY130A/LELO_INV.sym} -100 -340 0 0 {name=x2}
C {devices/lab_pin.sym} -120 -290 0 0 {name=p18 sig_type=std_logic lab=VSS}
C {devices/lab_pin.sym} -120 -390 0 0 {name=p19 sig_type=std_logic lab=VDD_0V8}
C {devices/lab_pin.sym} -160 -340 0 0 {name=p22 sig_type=std_logic lab=OUT}
C {devices/lab_pin.sym} -50 -340 0 1 {name=p23 sig_type=std_logic lab=EN}
C {devices/lab_pin.sym} -730 -120 0 0 {name=p24 sig_type=std_logic lab=EN}
