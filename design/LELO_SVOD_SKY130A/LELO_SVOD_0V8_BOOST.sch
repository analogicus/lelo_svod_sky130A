...
C {devices/lab_pin.sym} -400 -130 0 0 {name=p5 sig_type=std_logic lab=VSS}
...
C {devices/lab_pin.sym} 260 -300 1 0 {name=p8 sig_type=std_logic lab=VSS}
C {devices/lab_pin.sym} 260 -170 1 0 {name=p9 sig_type=std_logic lab=VSS}
...
C {devices/vsource.sym} -750 -140 0 0 {name=V3 value=0.8 savecurrent=false}
