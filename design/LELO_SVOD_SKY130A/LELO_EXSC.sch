...
N -480 -80 -480 -40 {lab=#net4}
N -480 -190 -480 -140 {lab=V1}
...
N -300 120 -300 160 {lab=VG2}
N -320 -190 -260 -190 {lab=V1}
N 190 -190 200 -190 {lab=V2}
N -480 -40 -480 0 {lab=#net4}
N 460 -40 460 -0 {lab=#net3}
N -260 -190 -200 -190 {lab=V1}
N 130 -190 190 -190 {lab=V2}
N -480 0 -450 0 {lab=#net4}
N -510 -0 -480 -0 {lab=#net4}
N -540 -0 -510 -0 {lab=#net4}
N -540 60 -510 60 {lab=0}
N -510 60 -480 60 {lab=0}
N 450 60 460 60 {lab=0}
N 460 60 620 60 {lab=0}
N 460 -40 460 0 {lab=#net3}
N 460 0 490 0 {lab=#net3}
N 430 0 460 0 {lab=#net3}
N 400 0 430 0 {lab=#net3}
N 400 60 430 60 {lab=0}
N 430 60 460 60 {lab=0}
...
C {devices/isource.sym} 830 -80 0 0 {name=I0 value=40n}
C {LELO_SVOD_SKY130A/1812PS-334_imp.sym} 460 -110 0 0 {name=x7}
C {LELO_SVOD_SKY130A/1812PS-334_imp.sym} 100 -190 1 0 {name=x6}
C {LELO_SVOD_SKY130A/1812PS-334_imp.sym} -170 -190 1 0 {name=x5}
...
C {LELO_SVOD_SKY130A/1812PS-334_imp.sym} -480 -110 0 1 {name=x8}
C {devices/lab_pin.sym} -300 120 0 1 {name=p20 sig_type=std_logic lab=VG2}
...
C {devices/lab_pin.sym} -300 190 2 1 {name=p25 sig_type=std_logic lab=0}
C {devices/lab_pin.sym} -300 250 2 1 {name=p26 sig_type=std_logic lab=VHSS1}
C {sky130_fd_pr/pfet_01v8.sym} -280 190 0 1 {name=M10
W=0.42
L=0.15
nf=1
mult=1
...
C {LELO_SVOD_SKY130A/DK11XEA100K86RBH01_DC0V_20degC.sym} -480 30 0 0 {name=x9}
C {LELO_SVOD_SKY130A/DK11XEA100K86RBH01_DC0V_20degC.sym} -510 30 0 0 {name=x11}
C {LELO_SVOD_SKY130A/DK11XEA100K86RBH01_DC0V_20degC.sym} -540 30 0 0 {name=x12}
C {LELO_SVOD_SKY130A/DK11XEA100K86RBH01_DC0V_20degC.sym} 460 30 0 0 {name=x13}
C {LELO_SVOD_SKY130A/DK11XEA100K86RBH01_DC0V_20degC.sym} 430 30 0 0 {name=x15}
C {LELO_SVOD_SKY130A/DK11XEA100K86RBH01_DC0V_20degC.sym} 400 30 0 0 {name=x16}
