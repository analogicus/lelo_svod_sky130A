...
N 470 -190 530 -190 {lab=VDDCS}
N 530 -190 590 -190 {lab=VDDCS}
N 590 -190 590 -160 {lab=VDDCS}
N 590 -100 590 -30 {lab=VSS}
...
C {devices/lab_pin.sym} 590 -190 0 1 {name=p10 sig_type=std_logic lab=VDDCS}
...
C {devices/lab_pin.sym} 590 -30 0 1 {name=p16 sig_type=std_logic lab=VSS}
...
C {devices/capa.sym} 590 -130 0 0 {name=C3
m=1
value=1000p
footprint=1206
device="ceramic capacitor"}
