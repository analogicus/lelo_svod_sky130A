...
C {devices/capa.sym} 140 0 1 0 {name=C6
m=1
value=150f
footprint=1206
device="ceramic capacitor"}
C {LELO_SVOD_SKY130A/LELO_INV.sym} 290 0 0 0 {name=x13}
...
C {devices/lab_pin.sym} 270 50 3 0 {name=p8 sig_type=std_logic lab=VSS}
...
C {devices/lab_pin.sym} 270 -50 0 0 {name=p19 sig_type=std_logic lab=VDD}
...
C {sky130_fd_pr/res_xhigh_po_0p35.sym} 190 160 0 0 {name=R1
L=30
model=res_xhigh_po_0p35
spiceprefix=X
mult=1}
C {devices/lab_pin.sym} 190 190 3 0 {name=p24 sig_type=std_logic lab=VSS}
