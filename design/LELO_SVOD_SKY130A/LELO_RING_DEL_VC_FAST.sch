...
N -150 120 -0 120 {lab=#net1}
N -150 180 -0 180 {lab=GND}
N -190 30 -190 150 {lab=VIN}
N -190 30 -40 30 {lab=VIN}
N -150 150 -140 150 {lab=GND}
N -140 150 -140 180 {lab=GND}
...
C {sky130_fd_pr/nfet_01v8_lvt.sym} -170 150 0 0 {name=M3
W=0.42
L=10
nf=1
mult=1
