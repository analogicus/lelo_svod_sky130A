...
N -990 -670 -990 -490 {lab=#net11}
N -990 -430 -990 -360 {lab=VSS}
N -990 -360 -760 -360 {lab=VSS}
N -1070 -700 -1070 -670 {lab=#net11}
N -1070 -670 -990 -670 {lab=#net11}
N -1110 -730 -1110 -360 {lab=VSS}
N -1110 -360 -990 -360 {lab=VSS}
N -580 -520 -580 -480 {lab=#net8}
...
C {sky130_fd_pr/cap_mim_m3_1.sym} 0 90 0 0 {name=C3 model=cap_mim_m3_1 W=11.7 L=62 MF=1 spiceprefix=X}
C {sky130_fd_pr/cap_mim_m3_1.sym} 180 90 0 0 {name=C1 model=cap_mim_m3_1 W=11.7 L=78 MF=1 spiceprefix=X}
...
C {devices/lab_pin.sym} 470 -490 1 0 {name=p7 sig_type=std_logic lab=VDD}
C {devices/lab_pin.sym} 470 -180 1 0 {name=p9 sig_type=std_logic lab=VDD}
...
C {devices/lab_pin.sym} 700 -210 1 0 {name=p37 sig_type=std_logic lab=VDD}
C {devices/lab_pin.sym} 700 -540 1 0 {name=p41 sig_type=std_logic lab=VDD}
...
L=700}
C {devices/lab_pin.sym} 990 -530 1 0 {name=p47 sig_type=std_logic lab=VDD}
...
C {sky130_fd_pr/cap_mim_m3_1.sym} -990 -460 0 0 {name=C2 model=cap_mim_m3_1 W=20 L=20 MF=3 spiceprefix=X}
C {sky130_fd_pr/pfet_01v8.sym} 970 -470 0 0 {name=M23
W=2
L=0.15
nf=1
mult=1
...
C {sky130_fd_pr/pfet_01v8.sym} 680 -480 0 0 {name=M3
W=2
L=0.15
nf=1
mult=1
...
C {sky130_fd_pr/pfet_01v8.sym} 680 -160 0 0 {name=M19
W=2
L=0.15
nf=1
mult=1
...
C {sky130_fd_pr/res_xhigh_po.sym} -580 -450 0 0 {name=R4
W=0.2
L=70
model=res_xhigh_po
spiceprefix=X
mult=1}
C {devices/lab_pin.sym} -600 -450 0 0 {name=p8 sig_type=std_logic lab=VDD
L=700}
