...
N -870 -760 -870 -730 {lab=VSS}
N -690 -760 -690 -730 {lab=VSS}
N -690 -790 -690 -760 {lab=VSS}
N -870 -790 -870 -760 {lab=VSS}
N -830 -730 -730 -730 {lab=bias_ref}
N -870 -700 -870 -620 {lab=#net10}
N -690 -700 -690 -620 {lab=bias_ref}
N -830 -590 -730 -590 {lab=#net10}
N -690 -420 -690 -380 {lab=#net11}
N -870 -650 -800 -650 {lab=#net10}
N -800 -650 -800 -590 {lab=#net10}
...
N -870 -560 -870 -480 {lab=#net12}
N -690 -560 -690 -480 {lab=#net13}
N -830 -450 -730 -450 {lab=#net12}
N -870 -510 -800 -510 {lab=#net12}
N -800 -510 -800 -450 {lab=#net12}
...
N -740 -620 -740 -590 {lab=#net10}
N -440 120 -220 120 {lab=VSS}
N -340 -750 -260 -750 {lab=#net9}
...
C {devices/lab_pin.sym} 430 -520 0 0 {name=p29 sig_type=std_logic lab=bias_ref}
C {devices/lab_pin.sym} 660 -500 0 0 {name=p30 sig_type=std_logic lab=bias_ref}
C {devices/lab_pin.sym} 430 -210 0 0 {name=p31 sig_type=std_logic lab=bias_ref}
C {devices/lab_pin.sym} 660 -190 0 0 {name=p32 sig_type=std_logic lab=bias_ref}
C {sky130_fd_pr/pfet_01v8_lvt.sym} 450 -520 0 0 {name=M18
W=1.92
L=1
nf=1
mult=10
...
C {sky130_fd_pr/pfet_01v8_lvt.sym} 680 -500 0 0 {name=M17
W=1.92
L=1
nf=1
mult=10
...
C {sky130_fd_pr/pfet_01v8_lvt.sym} 680 -190 0 0 {name=M19
W=1.92
L=1
nf=1
mult=10
...
C {sky130_fd_pr/pfet_01v8_lvt.sym} 450 -210 0 0 {name=M20
W=1.92
L=1
nf=1
mult=10
...
C {sky130_fd_pr/res_xhigh_po_0p35.sym} -220 90 0 1 {name=R3
L=2000
model=res_xhigh_po_0p35
spiceprefix=X
mult=1}
C {devices/lab_pin.sym} -770 -300 3 0 {name=p23 sig_type=std_logic lab=VSS}
C {devices/lab_pin.sym} -800 -790 1 0 {name=p26 sig_type=std_logic lab=VSS}
C {devices/lab_pin.sym} -200 90 1 0 {name=p34 sig_type=std_logic lab=VDD}
C {sky130_fd_pr/res_xhigh_po_0p35.sym} -690 -350 0 1 {name=R1
L=20
model=res_xhigh_po_0p35
spiceprefix=X
mult=1}
C {devices/lab_pin.sym} -670 -350 1 0 {name=p33 sig_type=std_logic lab=VDD}
C {devices/lab_pin.sym} -340 -750 1 0 {name=p28 sig_type=std_logic lab=bias_ref}
