...
C {devices/lab_pin.sym} -40 60 0 0 {name=p16 sig_type=std_logic lab=CLK}
...
C {devices/lab_pin.sym} 0 90 3 0 {name=p21 sig_type=std_logic lab=VSS}
...
C {JNW_ATR_SKY130A/JNWATR_NCH_2C5F0.sym} -40 60 0 0 {name=x12[0:3]}
...
C {LELO_SVOD_SKY130A/Transistors/SVOD_PCH_2C5F0.sym} 560 -250 0 0 {name=x14 }
