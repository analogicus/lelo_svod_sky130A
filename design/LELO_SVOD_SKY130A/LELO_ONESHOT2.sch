...
N -330 130 230 130 {lab=#net1}
N -330 20 -230 20 {lab=#net1}
N 40 -170 40 0 {lab=#net2}
N 40 -230 40 -200 {lab=VDD}
N -330 20 -330 130 {lab=#net1}
N 230 0 230 130 {lab=#net1}
...
N 370 -0 440 0 {lab=#net4}
N 550 0 610 0 {lab=PULSE}
N 300 -70 650 -70 {lab=VDD}
N 650 -70 650 -50 {lab=VDD}
N 480 -70 480 -50 {lab=VDD}
...
C {devices/lab_pin.sym} 580 0 1 0 {name=p17 sig_type=std_logic lab=PULSE}
...
C {LELO_SVOD_SKY130A/LELO_INV.sym} 500 0 0 0 {name=x2}
C {LELO_SVOD_SKY130A/LELO_INV.sym} 670 0 0 0 {name=x3}
C {devices/lab_pin.sym} 480 50 3 0 {name=p9 sig_type=std_logic lab=VSS}
C {devices/lab_pin.sym} 650 50 3 0 {name=p10 sig_type=std_logic lab=VSS}
C {devices/lab_pin.sym} 720 0 2 0 {name=p18 sig_type=std_logic lab=PULSEN}
