...
C {sky130_fd_pr/nfet_01v8.sym} 130 -250 0 0 {name=M18
W=0.42
L=0.15
nf=1 
mult=1
...
C {LELO_SVOD_SKY130A/LELO_NOR_RELOSC.sym} -60 -300 0 0 {name=x1}
C {LELO_SVOD_SKY130A/LELO_NOR_RELOSC.sym} -60 10 0 0 {name=x2}
