...
S {}
E {}
N -210 -90 -130 -90 {lab=#net1}
N -130 -90 60 -90 {lab=#net1}
N 490 -70 550 -70 {lab=OUT}
N 320 -70 380 -70 {lab=#net2}
N 210 -70 260 -70 {lab=#net3}
...
N 220 -240 220 -230 {lab=#net2}
N 220 -300 220 -270 {lab=VDD}
N 220 -230 220 -170 {lab=#net2}
N 220 -170 330 -170 {lab=#net2}
...
C {devices/lab_pin.sym} -280 -140 0 0 {name=p5 sig_type=std_logic lab=VDD}
