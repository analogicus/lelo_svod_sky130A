...
N -230 -50 -90 -50 {lab=VDD}
N -90 -50 50 -50 {lab=VDD}
N -230 50 -90 50 {lab=VSS}
N -90 50 50 50 {lab=VSS}
N -300 -110 -300 20 {lab=CLK}
...
N 50 -50 180 -50 {lab=VDD}
N 180 -50 290 -50 {lab=VDD}
N -300 -110 340 -110 {lab=CLK}
N 340 -110 350 -110 {lab=CLK}
N 350 -110 350 0 {lab=CLK}
...
C {devices/ipin.sym} 0 -50 1 0 {name=p1 lab=VDD}
