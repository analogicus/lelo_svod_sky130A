...
N 30 -360 70 -360 {lab=VDD1}
N 130 -360 220 -360 {lab=VOUT_0V8}
N 220 -360 260 -360 {lab=VOUT_0V8}
N 30 -80 70 -80 {lab=VDD2}
N 130 -80 220 -80 {lab=VOUT_1V8}
N 220 -80 260 -80 {lab=VOUT_1V8}
N 260 -360 260 -230 {lab=VOUT_0V8}
N 260 -230 270 -230 {lab=VOUT_0V8}
N 260 -80 260 50 {lab=VOUT_1V8}
N 260 50 270 50 {lab=VOUT_1V8}
C {devices/opin.sym} 320 -360 0 0 {name=p43 lab=OUT1}
...
C {devices/lab_pin.sym} 220 -360 3 1 {name=p13 sig_type=std_logic lab=VOUT_0V8}
...
C {devices/capa.sym} 220 -330 0 1 {name=C1
m=1
value=200n
footprint=1206
device="ceramic capacitor"}
C {devices/lab_pin.sym} 220 -300 3 0 {name=p18 sig_type=std_logic lab=0}
...
C {devices/lab_pin.sym} 100 -400 1 0 {name=p36 sig_type=std_logic lab=VCTRL}
C {devices/lab_pin.sym} 120 -400 3 1 {name=p8 sig_type=std_logic lab=VDD1}
...
C {devices/lab_pin.sym} 30 -360 2 1 {name=p34 sig_type=std_logic lab=VDD1}
C {devices/switch_ngspice.sym} 100 -360 3 1 {name=S2 model=SW1
...
C {devices/res.sym} 290 -360 1 0 {name=R2
value=1
footprint=1206
device=resistor
m=1}
...
C {devices/lab_pin.sym} -680 -200 2 0 {name=p48 sig_type=std_logic lab=VCTRL2}
C {devices/ipin.sym} -680 -200 2 1 {name=p49 lab=VCTRL2}
C {devices/lab_pin.sym} 320 -270 3 1 {name=p51 sig_type=std_logic lab=VDD1}
C {devices/switch_ngspice.sym} 300 -230 3 1 {name=S5 model=SW1
device_model=".MODEL SW1 SW 
+ VT=0 VH=0.001
+ RON=0.001 ROFF=10G "}
C {devices/opin.sym} 330 -230 0 0 {name=p52 lab=OUT2}
C {devices/lab_pin.sym} 320 10 3 1 {name=p53 sig_type=std_logic lab=VDD1}
C {devices/switch_ngspice.sym} 300 50 3 1 {name=S6 model=SW1
device_model=".MODEL SW1 SW 
+ VT=0 VH=0.001
+ RON=0.001 ROFF=10G "}
C {devices/opin.sym} 330 50 0 0 {name=p54 lab=OUT4}
C {devices/opin.sym} 320 -80 0 0 {name=p55 lab=OUT3}
C {devices/lab_pin.sym} 300 -270 1 0 {name=p22 sig_type=std_logic lab=VCTRL2}
C {devices/lab_pin.sym} 300 10 1 0 {name=p50 sig_type=std_logic lab=VCTRL2}
