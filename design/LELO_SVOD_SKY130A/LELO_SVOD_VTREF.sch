...
N 0 660 0 700 {lab=VSS}
N -90 10 -0 10 {lab=VREF}
N 0 570 0 600 {lab=V2}
N -40 630 -40 680 {lab=VSS}
N -40 680 0 680 {lab=VSS}
N 0 270 0 300 {lab=#net1}
N 0 -100 0 -60 {lab=#net2}
N 0 -270 0 -250 {lab=VDD}
N 0 360 0 390 {lab=#net3}
N -40 380 -40 420 {lab=#net3}
N -40 380 0 380 {lab=#net3}
N -40 290 -40 330 {lab=#net1}
N -40 290 0 290 {lab=#net1}
N -40 -30 -40 10 {lab=VREF}
N 0 -30 0 -0 {lab=VREF}
N 0 330 0 360 {lab=#net3}
N 0 420 0 450 {lab=#net4}
N 0 -280 0 -270 {lab=VDD}
N 0 -310 0 -280 {lab=VDD}
N 0 450 0 480 {lab=#net4}
N 0 540 0 570 {lab=V2}
N -40 470 -40 510 {lab=#net4}
N -40 470 0 470 {lab=#net4}
N 0 510 0 540 {lab=V2}
...
N 0 180 0 210 {lab=#net6}
N 0 240 0 270 {lab=#net7}
N -40 190 -40 240 {lab=#net6}
N -40 190 0 190 {lab=#net6}
...
C {devices/lab_pin.sym} 0 700 0 0 {name=p8 sig_type=std_logic lab=VSS}
C {devices/opin.sym} 70 10 0 0 {name=p9 lab=VREF}
C {sky130_fd_pr/pnp_05v5.sym} -20 630 0 0 {name=Q1
model=pnp_05v5_W3p40L3p40
m=100
spiceprefix=X
}
C {devices/lab_pin.sym} 0 590 0 0 {name=p29 sig_type=std_logic lab=V2}
...
C {sky130_fd_pr/nfet_01v8_lvt.sym} -20 330 0 0 {name=M9
W=1
L=0.6
nf=1
mult=12
...
C {sky130_fd_pr/nfet_01v8_lvt.sym} -20 420 0 0 {name=M1
W=1
L=0.6
nf=1
mult=12
...
C {sky130_fd_pr/nfet_01v8_lvt.sym} -20 510 0 0 {name=M2
W=1
L=0.6
nf=1
mult=12
