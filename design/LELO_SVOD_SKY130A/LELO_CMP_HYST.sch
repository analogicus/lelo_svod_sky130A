...
N 550 -240 550 -210 {lab=#net3}
N 550 -270 550 -240 {lab=#net3}
...
N -250 80 -210 80 {lab=BIAS}
N -210 80 -210 110 {lab=BIAS}
N -80 -280 -80 -160 {lab=#net4}
N 260 -280 260 -160 {lab=#net5}
N -80 -60 260 -60 {lab=#net1}
N -250 170 -160 170 {lab=VSS}
N -80 -250 -30 -250 {lab=#net4}
N -30 -310 -30 -250 {lab=#net4}
N -40 -310 -30 -310 {lab=#net4}
N -40 -310 -10 -310 {lab=#net4}
N 210 -250 260 -250 {lab=#net5}
N 210 -310 210 -250 {lab=#net5}
N 210 -310 220 -310 {lab=#net5}
N 190 -310 220 -310 {lab=#net5}
N 260 -340 260 -310 {lab=#net3}
N 150 -340 150 -310 {lab=#net3}
N 30 -340 30 -310 {lab=#net3}
N -80 -340 -80 -310 {lab=#net3}
N 30 -280 30 -250 {lab=#net5}
N 30 -250 260 -200 {lab=#net5}
N 150 -280 150 -250 {lab=#net4}
N -80 -200 150 -250 {lab=#net4}
N -80 -400 -80 -340 {lab=#net3}
N -80 -400 260 -400 {lab=#net3}
N 260 -400 260 -340 {lab=#net3}
N 150 -400 150 -340 {lab=#net3}
N 30 -400 30 -340 {lab=#net3}
N 260 -250 310 -250 {lab=#net5}
N 310 -310 310 -250 {lab=#net5}
N 310 -310 350 -310 {lab=#net5}
N -110 -250 -80 -250 {lab=#net4}
N -110 -310 -110 -250 {lab=#net4}
N -140 -310 -110 -310 {lab=#net4}
N -180 -340 -180 -310 {lab=#net3}
N -180 -400 -180 -340 {lab=#net3}
N -180 -400 -80 -400 {lab=#net3}
N 260 -400 390 -400 {lab=#net3}
N 390 -400 390 -340 {lab=#net3}
N 390 -340 390 -310 {lab=#net3}
...
N 550 -400 550 -270 {lab=#net3}
N 390 -400 550 -400 {lab=#net3}
N 550 -70 550 170 {lab=VSS}
N 390 170 550 170 {lab=VSS}
N -250 -400 -180 -400 {lab=#net3}
N -250 -400 -250 -170 {lab=#net3}
N -250 -170 -250 -140 {lab=#net3}
N -250 -110 -250 80 {lab=BIAS}
...
C {devices/ipin.sym} -250 -400 0 0 {name=p6 lab=VDD}
...
C {sky130_fd_pr/pfet_01v8_lvt.sym} -270 -140 0 0 {name=M16
W=1
L=20
nf=2
mult=4
...
C {devices/ipin.sym} -290 -140 0 0 {name=p12 lab=BIAS_REF}
