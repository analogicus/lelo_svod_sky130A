...
N 570 -20 650 -20 {lab=NUP}
N 570 -200 650 -200 {lab=#net5}
...
C {devices/lab_pin.sym} 1070 -400 2 1 {name=p64 sig_type=std_logic lab=CURRENT_ON_P}
C {devices/lab_pin.sym} 760 -20 0 1 {name=p72 sig_type=std_logic lab=UP}
C {devices/lab_pin.sym} 460 -200 0 0 {name=p75 sig_type=std_logic lab=SP}
C {LELO_SVOD_SKY130A/LELO_INV.sym} 520 -20 0 0 {name=x11}
C {devices/lab_pin.sym} 760 -200 0 1 {name=p79 sig_type=std_logic lab=DN}
...
C {devices/lab_pin.sym} 610 -20 3 1 {name=p91 sig_type=std_logic lab=NUP}
...
C {devices/lab_pin.sym} 1510 -170 2 1 {name=p23 sig_type=std_logic lab=NLSSU}
...
C {devices/ipin.sym} -970 -420 0 0 {name=p21 lab=NLSSU}
C {devices/lab_pin.sym} -970 -420 0 1 {name=p24 sig_type=std_logic lab=NLSSU}
...
C {devices/ipin.sym} -970 -360 0 0 {name=p46 lab=NEN_0V8}
C {devices/lab_pin.sym} -970 -360 0 1 {name=p48 sig_type=std_logic lab=NEN_0V8}
...
C {devices/lab_pin.sym} 1550 -260 0 0 {name=p84 sig_type=std_logic lab=VDD_0V8}
C {sky130_fd_pr/cap_mim_m3_1.sym} 1210 -50 0 0 {name=C1 model=cap_mim_m3_1 W=10 L=10 MF=20 spiceprefix=X}
C {devices/lab_pin.sym} -210 -260 1 0 {name=p50 sig_type=std_logic lab=VX_Sampl}
C {devices/ipin.sym} -970 -560 0 0 {name=p87 lab=VDD_0V8}
C {devices/lab_pin.sym} -970 -560 0 1 {name=p88 sig_type=std_logic lab=VDD_0V8}
...
C {LELO_SVOD_SKY130A/LELO_NOR.sym} 1570 -190 0 0 {name=x6}
C {devices/lab_pin.sym} 1510 -210 0 0 {name=p49 sig_type=std_logic lab=NEN_0V8}
C {sky130_fd_pr/pfet_01v8.sym} 1090 -200 0 0 {name=M2
W=1
L=0.15
nf=1
mult=1
...
C {sky130_fd_pr/pfet_01v8.sym} 1090 -400 0 0 {name=M3
W=1
L=0.15
nf=1
mult=1
